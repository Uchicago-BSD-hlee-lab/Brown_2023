...
npp7_sRNA.fastq.gz --> control_capseq.fastq.gz

prp17_sRNA.fastq.gz --> npp7_sRNA.fastq.gz

control_snpc4_sRNA.fastq.gz --> prp17_sRNA.fastq.gz

snpc4_sRNA.fastq.gz --> control_snpc4_sRNA.fastq.gz

control_ints1_dic1_sRNA.fastq.gz --> snpc4_sRNA.fastq.gz

ints1_sRNA.fastq.gz --> control_ints1_dic1_sRNA.fastq.gz

dic1_sRNA.fastq.gz --> ints1_sRNA.fastq.gz

control_capseq.fastq.gz --> dic1_sRNA.fastq.gz
